...
const Blogs = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="mb-5 blog-header">
        <div className="text-white w-50">
          <h3 className="text-warning blog-title">Difference between authorization and authentication</h3>
          <article className="mb-3 blog-desc">
            <span className="text-warning ">Authentication: </span>Authentication is the process of verifying your identity by confirming your credentials, such as your User Name/User ID and password. Using your credentials, the system determines whether you are who you claim you are. The system uses login passwords to verify the user's identity in both public and private networks. Authentication is normally done with a username and password, but it can also be done with factors of authentication, which are several methods to be authenticated.
          </article>
          <article className="mb-3 blog-desc">
            <span className="text-warning ">Authorization: </span>Authorization, on the other hand, occurs after the system successfully authenticates your identity, granting you complete access to resources such as information, files, databases, funds, places, and nearly anything else. Simply said, authorisation affects your capacity to access the system and the extent to which you can do so. After the system verifies your identity through successful authentication, you are granted access to the system's resources.
          </article>
        </div>
        <img className="img-fluid blog-img" src={blog1} alt="" />
      </div>
      <div className="blog-header my-5">
        <div className="text-white w-50">
          <h3 className="text-warning blog-title">Why are you using firebase? What other options do you have to implement authentication?</h3>
          <article className="mb-3 blog-desc">
            <span className="text-warning">Reason using firebase: </span>Connecting and using built-in third-party authentication providers, such as Google, Facebook, and Twitter, is a breeze with Firebase. Additionally, if someone wants to use a pre-built authentication UI, they can do so. All of them can help to save a lot of money on development because won't have to start from zero. Pricing for Firebase is also very flexible. Although there are pay-as-you-go options, if the app is still in its prime, you can start with a free subscription and enjoy the basic functions.
          </article>
          <article className="mb-3 blog-desc">
      ...
      <div className="blog-header my-5">
        ...
        <div className="text-white w-50">
          <h3 className="text-warning blog-title">What other services does firebase provide other than authentication?</h3>
          <article className="mb-3 blog-desc">
